  ...
  (
    ...
    return (
      <a
        href={href}
        className={twMerge(
          "block bg-gray-100 dark:bg-gray-900 focus-visible:bg-gray-100 hover:bg-gray-100 dark:focus-visible:bg-gray-900 dark:hover:bg-gray-900 rounded-md text-inherit decoration-inherit group/bookmark max-w-md",
          className
        )}
        ref={ref}
        {...props}
      >
        {imageSrc === undefined ? (
          <div className="aspect-[40/21] rounded-t-md overflow-clip w-full flex items-center justify-center bg-gray-200 dark:bg-gray-800">
            <svg
          ...
          <Image
            ...
            width={1200}
            height={630}
            className="object-cover aspect-[40/21] rounded-t-md w-full"
          />
        )}

        <div className="mt-5 px-4">
          <div className="leading-snug line-clamp-2 text-gray-900 dark:text-gray-100 text-base font-medium transition-colors group-hover/bookmark:text-blue-600 dark:group-hover/bookmark:text-blue-400 group-hover/bookmark:underline group-focus-visible/bookmark:text-blue-600 dark:group-focus-visible/bookmark:text-blue-400 group-focus-visible/bookmark:underline">
            {title === undefined
              ? "This website doesn't provide the page title."
              : title}
          </div>
        </div>
        ...
        {description === undefined ? null : (
          <div className="px-4 mt-4">
            <div className="leading-snug line-clamp-2 text-gray-500 text-sm">
              {description}
            </div>
          </div>
        )}

        <div className="px-4 mt-4 pb-4 flex items-center gap-x-2">
          {iconImageSrc === undefined ? (
            <GlobeAltIcon className="w-5 h-5 text-gray-500 -ml-0.5 -mr-1 -my-0.5" />
          ) : (
            <Image
              src={iconImageSrc}
              alt={href}
          ...
          <div className="leading-snug line-clamp-1 text-gray-500 text-sm font-mono">
            {href}
          </div>
        </div>
      </a>
