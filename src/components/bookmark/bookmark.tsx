  ...
  (
    ...
    return (
      <a href={href} className={clsx(css.root, className)} ref={ref} {...props}>
        {imageSrc === undefined ? (
          <div className={css["thumbnail-fallback"]}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 304 304"
              className={css["thumbnail-fallback-svg"]}
            >
              <path
        ...
        <div className={css.url}>
          {iconImageSrc === undefined ? (
            <GlobeAltIcon className={css["url-icon-fallback"]} />
          ) : (
            <Image
              src={iconImageSrc}
              alt={href}
              width={64}
              height={64}
              className={css["url-icon"]}
            />
          )}

          <div className={css["url-text"]}>{href}</div>
        </div>
      </a>
    );
  },
